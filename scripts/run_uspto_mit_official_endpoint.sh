...
STAGE_MANIFEST=data/clm_jepa_uspto_mit_official_endpoint/prespecified_stage1_1280.jsonl
FULL_MANIFEST=data/clm_jepa_uspto_mit_official_endpoint/prespecified_3300_sequential.jsonl
...
env PYTHONPATH=src .venv-457/bin/python scripts/design_uspto_mit_endpoint.py interim \
