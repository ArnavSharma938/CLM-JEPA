...
The target-side stop-gradient intervention and its 32-reaction evaluation are reported separately in [`USPTO_MIT_TARGET_STOP_GRADIENT_RESCUE.md`](USPTO_MIT_TARGET_STOP_GRADIENT_RESCUE.md). They are not part of this original geometry and decoder-coupling diagnosis.
